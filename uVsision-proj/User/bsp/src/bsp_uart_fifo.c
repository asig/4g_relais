...
//	GPIO_InitStruct.Alternate = USART2_RX_AF;
	...
	CLEAR_BIT(USART4->SR, USART_SR_TC);   /* 清除TC发送完成标志 */
    CLEAR_BIT(USART4->SR, USART_SR_RXNE); /* 清除RXNE接收标志 */
	...
	CLEAR_BIT(USART5->SR, USART_SR_TC);   /* 清除TC发送完成标志 */
    CLEAR_BIT(USART5->SR, USART_SR_RXNE); /* 清除RXNE接收标志 */
	...
	CLEAR_BIT(USART7->SR, USART_SR_TC);   /* 清除TC发送完成标志 */
    CLEAR_BIT(USART7->SR, USART_SR_RXNE); /* 清除RXNE接收标志 */
	...
	CLEAR_BIT(USART8->SR, USART_SR_TC);   /* 清除TC发送完成标志 */
    CLEAR_BIT(USART8->SR, USART_SR_RXNE); /* 清除RXNE接收标志 */
